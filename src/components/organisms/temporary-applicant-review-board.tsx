          ...
          <div className="max-w-2xl space-y-4">
            ...
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-slate-600">
                Review submitted applications, create new temporary applicant
                invites, and convert approved applicants into official members.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-600">
                  These applicants have finished sign-up and are ready for
                  review.
                </p>
              </div>
                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                      ...
                      <form action={confirmAction}>
                        ...
                        <Button
                          disabled={
                            confirmPending || !applicant.applicant_user_id
                          }
                          type="submit"
                          variant="secondary"
                        >
