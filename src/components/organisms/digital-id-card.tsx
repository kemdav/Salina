...
export function DigitalIdCard({
  ...
  return (
    <div
      id="digital-id-badge"
      className="w-full max-w-[640px] mx-auto bg-white rounded-2xl overflow-hidden shadow-2xl border border-slate-200 flex flex-col sm:flex-row relative group"
    >
      ...
      >
        ...
        <div
          className="relative group/avatar cursor-pointer z-10 mb-6"
        ...
        >
          ...
          <div className="w-28 h-28 rounded-full border-4 border-white bg-slate-100 flex items-center justify-center overflow-hidden shadow-xl">
            {avatarPreview ? (
              ...
              <svg
                className="w-20 h-20 text-slate-300 mt-6"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
                <path
      ...
      <div className="sm:w-[60%] flex flex-col p-6 sm:p-8 relative">
        ...
        <div className="pt-5 border-t border-slate-100 mt-auto">
          <span className="text-[10px] uppercase tracking-wider font-semibold text-slate-500 mb-2 block">
            Access Permissions
          </span>
          <div className="flex flex-wrap gap-1.5">
            {user.accessPermissions.map((perm, idx) => (
              <span
                key={idx}
                className="text-[10px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded border border-slate-200 font-medium tracking-wide"
              >
                {perm}
              </span>
            ))}
