  ...
  return (
    <main className="flex-1 flex items-center">
      <section className="px-8 py-12 max-w-[var(--grid-max-width)] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="w-full aspect-[4/3] lg:aspect-square bg-slate-50 border-2 border-dashed border-border rounded-(--radius) flex flex-col items-center justify-center text-[var(--muted)] shadow-sm">
          <svg
