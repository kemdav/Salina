      ...
      <div className="flex-1 flex flex-col w-full h-full">
        <div className="w-full h-full bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl p-5 sm:p-8 flex flex-col shadow-inner">
          ...
          >
            ...
            >
              <div className="flex items-center gap-2 mb-0 sm:mb-4">
                <div
                  className="w-6 h-6 shrink-0 rounded-md transition-colors duration-300"
                  style={{ backgroundColor: "var(--preview-primary)" }}
                />
                <div
                  className="hidden sm:block h-3 w-16 rounded opacity-80 transition-colors duration-300"
              ...
              <div className="flex flex-row sm:flex-col gap-2">
                <div
                  className="h-8 w-8 sm:w-full rounded-md flex items-center justify-center sm:justify-start sm:px-2 gap-2 transition-colors duration-300"
                ...
                >
                  ...
                  />
                  <div
                    className="hidden sm:block h-2 w-12 rounded transition-colors duration-300"
                    style={{ backgroundColor: "var(--preview-accent)" }}
                  />
                </div>
                <div className="h-8 w-8 sm:w-full rounded-md flex items-center justify-center sm:justify-start sm:px-2 gap-2">
                  ...
                  <div
                    className="hidden sm:block h-2 w-16 rounded opacity-30 transition-colors duration-300"
                    style={{ backgroundColor: "var(--preview-text)" }}
                  />
                </div>
              </div>
            ...
            <div
              className="w-full sm:w-2/3 p-4 sm:p-6 flex flex-col relative transition-colors duration-300"
              style={{ backgroundColor: "var(--preview-bg)" }}
            >
              <div className="flex justify-between items-start mb-4 sm:mb-6">
                <div>
                  <h4
                    className="text-lg sm:text-xl font-bold leading-none tracking-tight mb-1.5 sm:mb-2 transition-colors duration-300"
                    style={{
                ...
                <button
                  type="button"
                  className="px-3 py-1.5 text-[10px] sm:text-[11px] text-white rounded-md shadow-sm font-medium hover:opacity-90 transition-all duration-300 whitespace-nowrap"
                  style={{
              ...
              <div className="flex flex-col gap-2 sm:gap-3 flex-1">
                <div
                  className="p-2.5 sm:p-3 rounded-lg flex items-center justify-between transition-colors duration-300"
                  style={{
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="w-6 h-6 sm:w-8 sm:h-8 shrink-0 rounded flex items-center justify-center transition-colors duration-300"
                    ...
                    <div className="flex flex-col gap-1.5">
                      <div
                        className="h-2 w-16 sm:w-20 rounded transition-colors duration-300"
                        style={{ backgroundColor: "var(--preview-text)" }}
                      />
                      <div
                        className="h-1.5 w-10 sm:w-12 rounded opacity-40 transition-colors duration-300"
                        style={{ backgroundColor: "var(--preview-text)" }}
                      />
                    </div>
                  </div>
                  <div
                    className="px-2 py-0.5 rounded-full text-[8px] sm:text-[9px] text-white font-medium tracking-wide transition-colors duration-300"
                    style={{ backgroundColor: "var(--preview-primary)" }}
                  >
                    Edit
                  </div>
          ...
          <div className="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-[#E5E7EB] flex flex-col gap-3 sm:gap-4">
            ...
            >
              <h2
                className="text-2xl sm:text-3xl font-bold tracking-tight leading-tight sm:leading-none transition-all duration-300"
                style={{ fontFamily: headingFont }}
              >
                The quick brown fox.
              </h2>
              <h3
                className="text-xl sm:text-2xl font-semibold tracking-tight leading-tight sm:leading-none transition-all duration-300"
                style={{ fontFamily: titleFont }}
              >
                Jumps over the lazy dog.
              </h3>
              <p
                className="text-xs sm:text-sm leading-relaxed opacity-80 transition-all duration-300"
                style={{ fontFamily: bodyFont }}
              >
                0123456789. Global typography will inherit these properties
                across all tenant interfaces.
              </p>
            </div>
          </div>
        </div>
