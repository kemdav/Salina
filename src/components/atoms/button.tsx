  ...
  ({ className, type = "button", variant = "primary", ...props }, ref) => {
    ...
    return (
      <button
        ...
        type={type}
        className={cn(
          "inline-flex items-center justify-center rounded-(--radius) px-4 py-2 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:pointer-events-none disabled:opacity-60",
          variantClasses,
          className,
        )}
        {...props}
