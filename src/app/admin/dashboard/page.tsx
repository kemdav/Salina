...
const ACTIVITIES = [
    { initials: 'JD', name: 'John Doe',       action: 'joined as Member',       time: '2 hours ago'  },
    { initials: 'AS', name: 'Anna Smith',     action: 'submitted application',  time: '5 hours ago'  },
    { initials: 'RJ', name: 'Robert Johnson', action: 'paid dues',              time: 'Yesterday'    },
];
