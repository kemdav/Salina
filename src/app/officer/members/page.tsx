...
const rosterRows = [
    { name: "Excel Santos", role: "Human Resources Officer", status: "Active", committee: "Executive", attendance: "94%" },
    { name: "Camille Reyes", role: "Secretary", status: "Active", committee: "Documentation", attendance: "97%" },
    { name: "Andrei Cruz", role: "Treasurer", status: "On leave", committee: "Finance", attendance: "81%" },
    { name: "Mika Delgado", role: "Public Relations", status: "Active", committee: "Events", attendance: "89%" },
    { name: "Jules Navarro", role: "Member", status: "Pending", committee: "Outreach", attendance: "73%" },
];
                        ...
                        <div className="max-w-2xl space-y-4">
                            ...
                            <div>
                                ...
                                <p className="mt-3 text-sm leading-6 text-slate-500">
                                    Track current members, committee assignments, and attendance levels in a single data table.
                                </p>
                            </div>
                        </div>
                ...
                <section className="grid gap-6 xl:grid-cols-[minmax(0,1.55fr)_minmax(320px,0.75fr)]">
                    <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm lg:p-7">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <Input className="max-w-md" placeholder="Search name, role, or committee" aria-label="Search roster" />
                                ...
                                <tbody className="divide-y divide-slate-200 bg-white">
                                    {rosterRows.map((member) => (
                                        <tr key={member.name} className="align-top">
                                            ...
                                            <td className="px-4 py-4 text-slate-600">{member.committee}</td>
                                            <td className="px-4 py-4 text-slate-600">{member.attendance}</td>
                                            <td className="px-4 py-4">
                    ...
                    <aside className="space-y-6">
                        ...
                        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                            <h3 className="text-lg font-semibold text-slate-900">Committee snapshot</h3>
                            <div className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
