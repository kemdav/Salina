    ...
    return (
        <div style={{ fontFamily: 'var(--font-body)' }}>
                        ...
                        <div>
                                ...
                                >
                                    <span
                                        className={`absolute top-1 h-4 w-4 rounded-full bg-white transition-transform ${
                                            mfaEnabled ? 'left-1 translate-x-4' : 'left-1 translate-x-0'
                                        }`}
                                    />
                                </button>
                            </div>
                            ...
                            <div className="mt-6 flex items-center justify-between">
                                ...
                                <input
                                    ...
                                    className="h-9 w-20 rounded-[var(--radius)] border border-border px-3 text-center text-sm text-foreground outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/10"
                                />
                            </div>
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr className="border-b border-border">
                                            {['Role Name', 'Users', 'Access Level', 'Actions'].map((col) => (
                                                <th
                                                    key={col}
                        ...
                        <div>
                            ...
                            <div className="mb-5">
                                ...
                                <select
                                    ...
                                    className="h-11 w-full rounded-[var(--radius)] border border-border bg-white px-3 text-sm text-foreground outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/10"
                                >
                                    <option value="america-pacific">(GMT-08:00) Pacific Time</option>
                                    <option value="america-mountain">(GMT-07:00) Mountain Time</option>
                                    <option value="america-central">(GMT-06:00) Central Time</option>
                                    <option value="america-eastern">(GMT-05:00) Eastern Time</option>
            ...
            <div className="mt-8 flex justify-end gap-3">
                <button
                    type="button"
                    className="rounded-[var(--radius)] border border-border bg-white px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-slate-50"
                >
                    Reset changes
                </button>
                <button
                    type="button"
                    className="rounded-[var(--radius)] bg-foreground px-4 py-2 text-sm font-medium text-background opacity-100 transition-opacity hover:opacity-90"
                >
