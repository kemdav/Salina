...
const RECENT_ORGS = [
    { initials: "AL", name: "Aether Labs",       slug: "aether-labs",   status: "ACTIVE",   created: "Oct 20" },
    { initials: "VS", name: "Vanguard Systems",  slug: "vanguard-sys",  status: "PENDING",  created: "Oct 19" },
    { initials: "NX", name: "Nexus Core",        slug: "nexus-core",    status: "ACTIVE",   created: "Oct 18" },
    { initials: "OP", name: "Optic Prime",       slug: "optic-prime",   status: "INACTIVE", created: "Oct 15" },
    { initials: "QM", name: "Quantum Mechanics", slug: "quantum-mech",  status: "ACTIVE",   created: "Oct 12" },
];
...
const ACCREDITATION_REQUESTS = [
    { title: "ISO 27001 Certification Request", sub: "Submitted by Aether Labs · 3 hours ago" },
    { title: "Annual Security Audit",           sub: "Submitted by Nexus Core · 5 hours ago" },
    { title: "Governance Compliance Check",     sub: "Submitted by Optic Prime · Yesterday" },
];
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-border bg-slate-50/50">
                                {["Org Name", "Slug", "Status", "Created", "Actions"].map((col) => (
                                    <th
                                        key={col}
                        ...
                        <tbody>
                            {RECENT_ORGS.map((org) => (
                                <tr key={org.slug} className="border-b border-border last:border-0">
                                    ...
                                    <td className="px-4 py-3 cursor-pointer text-slate-400">
                                        ⋯
                                    </td>
                                </tr>
                            ))}
