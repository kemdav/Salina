  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
            ...
            <Link href="/reset-password" className="transition-colors duration-200 hover:text-[var(--primary)]" style={{ fontSize: '12px', color: 'var(--muted)', textDecoration: 'none', fontFamily: 'var(--font-body)' }}>
              Forgot password?
            </Link>
          </div>
          <div style={{ position: 'relative' }}>
            <input
              id="password" type={showPassword ? 'text' : 'password'} aria-label="Password"
        ...
        {/* Error */}
        {error && (
          <p role="alert" style={{ margin: 0, fontSize: '13px', color: 'var(--destructive)', fontFamily: 'var(--font-body)' }}>
            {error}
          </p>
        )}
      ...
      <p style={{ margin: '28px 0 0', textAlign: 'center', fontSize: '14px', color: 'var(--muted)', fontFamily: 'var(--font-body)' }}>
        ...
        <Link href="/sign-up" className="font-semibold hover:underline transition-colors duration-200" style={{ color: 'var(--primary)', textDecoration: 'none' }}>
          Sign up
        </Link>
      </p>
    </div>
